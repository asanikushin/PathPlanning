...
//It's a natural path for Dijkstra, A*, JP_Search (e.g. these algorithms find this sort of path).
...
// A*-JP_Search-Dijkstra-etc. naturally generate lppath. One might post-process it by skipping the nodes at which
